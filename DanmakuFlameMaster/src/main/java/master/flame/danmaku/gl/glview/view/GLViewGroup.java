...
public class GLViewGroup {
    ...
    private static final boolean DEBUG = GLConstants.DEBUG_GLVIEWGROUP;
    private static final boolean DEBUG_DRAW = GLConstants.DEBUG_GLVIEWGROUP_DRAW;
    private static final boolean DEBUG_INIT = GLConstants.DEBUG_GLVIEWGROUP_INIT;
    private static final boolean DEBUG_RELEASE = GLConstants.DEBUG_GLVIEWGROUP_RELEASE;
    private static final boolean DEBUG_ADD = GLConstants.DEBUG_GLVIEWGROUP_ADD;
     ...
     */
    private final Collection<GLView> mRunningViews =
            Collections.synchronizedSortedSet(new TreeSet<>(zComparator));
    /**
    ...
    public void removeView(Object view) {
        ...
        if (view instanceof BaseDanmaku) {
            ...
            if (!mNewDanmaku.remove(view)) {
                try {
                    for (GLView glView : Collections
                            .synchronizedList(new ArrayList<>(mRunningViews))) {
