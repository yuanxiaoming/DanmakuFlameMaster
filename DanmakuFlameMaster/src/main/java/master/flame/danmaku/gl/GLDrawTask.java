...
public class GLDrawTask extends DrawTask {
    private static final boolean DEBUG = GLConstants.DEBUG_GLDRAWTASK;
    ...
    public void invalidateDanmaku(BaseDanmaku item, boolean remeasure) {
        ...
        if (mCacheManager != null) {
            if (DEBUG) {
                DanmakuLoggers
                        .i(TAG, "invalidateDanmaku id = " + item.id + " text = " + item.text);
            }
    ...
    public class GLCacheManager implements ICacheManager {
        ...
        private static final boolean DEBUG = GLConstants.DEBUG_GLCACHEMANAGER;
         ...
         */
        private final Danmakus mCachedDanmakus = new Danmakus(IDanmakus.ST_BY_LIST);
        ...
        public void addDanmaku(BaseDanmaku danmaku) {
            if (mHandler != null && danmaku != null) {
                if (DEBUG) {
                    DanmakuLoggers
                            .i(TAG, "addDanmaku id = " + danmaku.id + " text = " + danmaku.text);
                }
        ...
        void removeDanmaku(BaseDanmaku danmaku) {
            if (mHandler != null) {
                if (DEBUG) {
                    DanmakuLoggers.i(TAG,
                            "removeCachedDanmaku id = " + danmaku.id + " text = " + danmaku.text);
                }
                synchronized (mCacheTasks) {
        ...
        private class GLCacheDrawHandler extends Handler {
            ...
            private static final boolean DEBUG = GLConstants.DEBUG_GLCACHEDRAWHANDLER;
            ...
            private void buildFutureDanmaku() {
                ...
                if (DEBUG) {
                    DanmakuLoggers
                            .i(TAG, "buildFutureDanmaku validBuildSize = " + validBuildSize.get() +
