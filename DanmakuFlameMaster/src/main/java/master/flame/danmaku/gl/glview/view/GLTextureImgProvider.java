...
public abstract class GLTextureImgProvider<D> {
    ...
    private static final boolean DEBUG_CREATE_TEXTURE = GLConstants.DEBUG_GLVIEW_CREATE_TEXTURE;
    private static final boolean DEBUG_RELEASE_TEXTURE = GLConstants.DEBUG_GLVIEW_RELEASE_TEXTURE;
